---
title: "Alternating MoS Poisson SuSiE Updates"
output:
  html_document:
    toc: true
    toc_float: true
...
This file tests the alternating hard-motif MoS-Poisson-SuSiE update. Both
...
hard motifs inside the MoS loop.
...
fit_frozen_and_alternating = function(dat, K, S, D, init_seed,
  ...
  frozen = mos_poi_susie_fixed_motifs(
    Y = dat$Y,
    F = mf_fit$F,
  ...
  alternating = mos_poi_susie_fixed_motifs(
    Y = dat$Y,
    F = mf_fit$F,
    motifs = motif_init$motifs,
    max_iters = mos_max_iters,
...
plot_group_responsibilities(
  ...
  block$grp,
  "Block scenario: frozen MoS responsibilities"
)

plot_group_responsibilities(
  block_pair$alternating$omega,
  block$grp,
  "Block scenario: alternating MoS responsibilities"
)
...
plot_group_responsibilities(
  ...
  tree$grp,
  "Tree scenario: frozen MoS responsibilities"
)

plot_group_responsibilities(
  tree_pair$alternating$omega,
  tree$grp,
  "Tree scenario: alternating MoS responsibilities"
)
