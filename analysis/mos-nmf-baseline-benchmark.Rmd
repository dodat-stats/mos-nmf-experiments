---
title: "MoS-NMF Baseline Benchmark"
output:
  html_document:
    toc: true
    toc_float: true
...
This file compares soft MoS-NMF with two simple baselines:
...
fit_soft_mos_method = function(dat, K, S, D, seed, max_iters = 18,
...
to watch are not only factor recovery. The paper claim requires MoS-NMF to
...
The current result is strongest in the block scenario, where soft MoS-NMF
improves clustering, support recovery, and factor recovery. In the tree
scenario, the result is more nuanced: soft MoS-NMF improves support accuracy
